...
from ganb_personal_client.models.balance import Balance  # noqa: F401,E501
from ganb_personal_client.models.sp_account_balance import SpAccountBalance  # noqa: F401,E501
...
class BalancesResponse(object):
    ...
    swagger_types = {
        ...
        'sp_account_balances': 'list[SpAccountBalance]'
    }
    ...
    def __init__(self, balances=None, sp_account_balances=None):  # noqa: E501
        """BalancesResponse - a model defined in Swagger"""  # noqa: E501

        self._balances = None
        self._sp_account_balances = None
        self.discriminator = None

        if balances is not None:
            self.balances = balances
        if sp_account_balances is not None:
            self.sp_account_balances = sp_account_balances

    @property
    def balances(self):
        """Gets the balances of this BalancesResponse.  # noqa: E501

        残高情報リスト 該当する情報が無い場合は、空のリストを返却します   # noqa: E501
    ...
    @property
    def sp_account_balances(self):
        """Gets the sp_account_balances of this BalancesResponse.  # noqa: E501

        つかいわけ口座残高情報リスト 該当する情報が無い場合は、項目自体を設定しません   # noqa: E501

        :return: The sp_account_balances of this BalancesResponse.  # noqa: E501
        :rtype: list[SpAccountBalance]
        """
        return self._sp_account_balances

    @sp_account_balances.setter
    def sp_account_balances(self, sp_account_balances):
        """Sets the sp_account_balances of this BalancesResponse.

        つかいわけ口座残高情報リスト 該当する情報が無い場合は、項目自体を設定しません   # noqa: E501

        :param sp_account_balances: The sp_account_balances of this BalancesResponse.  # noqa: E501
        :type: list[SpAccountBalance]
        """

        self._sp_account_balances = sp_account_balances
