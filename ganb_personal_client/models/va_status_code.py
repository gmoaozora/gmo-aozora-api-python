...
class VaStatusCode(object):
    ...
    def __init__(self, va_status_code=None):  # noqa: E501
        """VaStatusCode - a model defined in Swagger"""  # noqa: E501

        self._va_status_code = None
        self.discriminator = None

        if va_status_code is not None:
            self.va_status_code = va_status_code

    @property
    def va_status_code(self):
        """Gets the va_status_code of this VaStatusCode.  # noqa: E501

        振込入金口座　状態コード 半角数字 ・1=利用可能 ・2=停止中 ・3=削除済   # noqa: E501

        :return: The va_status_code of this VaStatusCode.  # noqa: E501
        :rtype: str
        """
    ...
    def va_status_code(self, va_status_code):
        """Sets the va_status_code of this VaStatusCode.

        振込入金口座　状態コード 半角数字 ・1=利用可能 ・2=停止中 ・3=削除済   # noqa: E501

        :param va_status_code: The va_status_code of this VaStatusCode.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(VaStatusCode, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VaStatusCode):
            return False
