# ganb_corporate_client.TransferApi
...
api_instance = ganb_corporate_client.TransferApi()
...
# create an instance of the API class
api_instance = ganb_corporate_client.TransferApi()
body = ganb_corporate_client.TransferRequest() # TransferRequest | HTTPリクエストボディ
x_access_token = 'x_access_token_example' # str | アクセストークン  minLength: 1 maxLength: 128 
