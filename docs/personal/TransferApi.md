...
api_instance = ganb_personal_client.TransferApi()
body = ganb_personal_client.SpAccountTransferRequest() # SpAccountTransferRequest | HTTPリクエストボディ
...
# create an instance of the API class
api_instance = ganb_personal_client.TransferApi()
body = ganb_personal_client.TransferRequest() # TransferRequest | HTTPリクエストボディ
x_access_token = 'x_access_token_example' # str | アクセストークン  minLength: 1 maxLength: 128 
