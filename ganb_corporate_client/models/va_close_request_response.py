...
class VaCloseRequestResponse(object):
    ...
    def accept_date(self):
        ...
        解約申込受付日 解約申込を受け付けた日付を示します YYYY-MM-DD形式   # noqa: E501
    ...
    def accept_date(self, accept_date):
        ...
        if accept_date is not None and len(accept_date) > 10:
            raise ValueError("Invalid value for `accept_date`, length must be less than or equal to `10`")  # noqa: E501
        if accept_date is not None and len(accept_date) < 10:
            raise ValueError("Invalid value for `accept_date`, length must be greater than or equal to `10`")  # noqa: E501
