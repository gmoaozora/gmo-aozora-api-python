...
from ganb_corporate_client.models.transaction import Transaction  # noqa: F401,E501
...
class TransactionsResponse(object):
    ...
    def __init__(self, account_id=None, currency_code=None, currency_name=None, date_from=None, date_to=None, base_date=None, base_time=None, has_next=None, next_item_key=None, count=None, transactions=None):  # noqa: E501
    ...
    @property
    def account_id(self):
        """Gets the account_id of this TransactionsResponse.  # noqa: E501

        口座ID 半角英数字 口座を識別するID   # noqa: E501

        :return: The account_id of this TransactionsResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def account_id(self, account_id):
        """Sets the account_id of this TransactionsResponse.

        口座ID 半角英数字 口座を識別するID   # noqa: E501

        :param account_id: The account_id of this TransactionsResponse.  # noqa: E501
        :type: str
        """
    ...
    def currency_code(self):
        """Gets the currency_code of this TransactionsResponse.  # noqa: E501

        通貨コード 半角文字 ISO4217に準拠した通貨コード   # noqa: E501

        :return: The currency_code of this TransactionsResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def currency_code(self, currency_code):
        """Sets the currency_code of this TransactionsResponse.

        通貨コード 半角文字 ISO4217に準拠した通貨コード   # noqa: E501

        :param currency_code: The currency_code of this TransactionsResponse.  # noqa: E501
        :type: str
        """
    ...
    def currency_name(self):
        """Gets the currency_name of this TransactionsResponse.  # noqa: E501

        通貨名 全角文字 ISO4217に準拠した通貨コードの当行での名称   # noqa: E501

        :return: The currency_name of this TransactionsResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def currency_name(self, currency_name):
        """Sets the currency_name of this TransactionsResponse.

        通貨名 全角文字 ISO4217に準拠した通貨コードの当行での名称   # noqa: E501

        :param currency_name: The currency_name of this TransactionsResponse.  # noqa: E501
        :type: str
        """
    ...
    @property
    def date_from(self):
        """Gets the date_from of this TransactionsResponse.  # noqa: E501

        対象期間From 半角文字 YYYY-MM-DD形式 リクエストに対象期間From、Toが設定されていない場合は当日日付が設定されます   # noqa: E501

        :return: The date_from of this TransactionsResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def date_from(self, date_from):
        """Sets the date_from of this TransactionsResponse.

        対象期間From 半角文字 YYYY-MM-DD形式 リクエストに対象期間From、Toが設定されていない場合は当日日付が設定されます   # noqa: E501

        :param date_from: The date_from of this TransactionsResponse.  # noqa: E501
        :type: str
        """
    ...
    @property
    def date_to(self):
        """Gets the date_to of this TransactionsResponse.  # noqa: E501

        対象期間To 半角文字 YYYY-MM-DD形式 リクエストに対象期間From、Toが設定されていない場合は当日日付が設定されます   # noqa: E501

        :return: The date_to of this TransactionsResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def date_to(self, date_to):
        """Sets the date_to of this TransactionsResponse.

        対象期間To 半角文字 YYYY-MM-DD形式 リクエストに対象期間From、Toが設定されていない場合は当日日付が設定されます   # noqa: E501

        :param date_to: The date_to of this TransactionsResponse.  # noqa: E501
        :type: str
        """
        if date_to is None:
    ...
    @property
    def base_date(self):
        """Gets the base_date of this TransactionsResponse.  # noqa: E501

        基準日 入出金明細を照会した基準日を示します YYYY-MM-DD形式   # noqa: E501

        :return: The base_date of this TransactionsResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def base_date(self, base_date):
        """Sets the base_date of this TransactionsResponse.

        基準日 入出金明細を照会した基準日を示します YYYY-MM-DD形式   # noqa: E501

        :param base_date: The base_date of this TransactionsResponse.  # noqa: E501
        :type: str
        """
    ...
    @property
    def base_time(self):
        """Gets the base_time of this TransactionsResponse.  # noqa: E501

        基準時刻 入出金明細を照会した基準時刻を示します HH:MM:SS+09:00形式   # noqa: E501

        :return: The base_time of this TransactionsResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def base_time(self, base_time):
        """Sets the base_time of this TransactionsResponse.

        基準時刻 入出金明細を照会した基準時刻を示します HH:MM:SS+09:00形式   # noqa: E501

        :param base_time: The base_time of this TransactionsResponse.  # noqa: E501
        :type: str
        """
    ...
    @property
    def has_next(self):
        """Gets the has_next of this TransactionsResponse.  # noqa: E501

        次明細フラグ ・true=次明細あり ・false=次明細なし   # noqa: E501

        :return: The has_next of this TransactionsResponse.  # noqa: E501
        :rtype: bool
        """
    ...
    def has_next(self, has_next):
        """Sets the has_next of this TransactionsResponse.

        次明細フラグ ・true=次明細あり ・false=次明細なし   # noqa: E501

        :param has_next: The has_next of this TransactionsResponse.  # noqa: E501
        :type: bool
        """
        if has_next is None:
    ...
    def next_item_key(self):
        """Gets the next_item_key of this TransactionsResponse.  # noqa: E501

        次明細キー 半角数字 次明細フラグがfalseの場合は、項目自体を設定しません   # noqa: E501

        :return: The next_item_key of this TransactionsResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def next_item_key(self, next_item_key):
        """Sets the next_item_key of this TransactionsResponse.

        次明細キー 半角数字 次明細フラグがfalseの場合は、項目自体を設定しません   # noqa: E501

        :param next_item_key: The next_item_key of this TransactionsResponse.  # noqa: E501
        :type: str
        """
    ...
    def transactions(self):
        """Gets the transactions of this TransactionsResponse.  # noqa: E501

        入出金明細情報リスト 該当する情報が無い場合は、空のリストを返却します   # noqa: E501

        :return: The transactions of this TransactionsResponse.  # noqa: E501
    ...
    def transactions(self, transactions):
        ...
        :param transactions: The transactions of this TransactionsResponse.  # noqa: E501
