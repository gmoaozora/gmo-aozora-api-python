...
class VirtualAccountApi(object):
    ...
    def deposit_transactions_using_get(self, x_access_token, **kwargs):  # noqa: E501
        ...
        :param str va_contract_auth_key: 振込入金口座API認証情報 半角英数字 銀行契約の方はNULLを設定 提携企業の方が、契約された顧客の入金明細照会を依頼される場合は必須 提携企業以外の方が値を設定されている場合は「400 Bad Request」を返却  minLength: 1 maxLength: 400 
    ...
    def va_close_request_using_post(self, x_access_token, **kwargs):  # noqa: E501
        ...
        振込入金口座契約の解約申込を行います 解約は解約受付月の月末に行われます   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
